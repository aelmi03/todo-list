...
const todayProject = (() => {
    ...
    const makeTodayProject = (e) => {
        ...
        const todayTasks = _application_logic_data__WEBPACK_IMPORTED_MODULE_1__.Data.getProjectsDueToday();
    }
    const initializeToday = () => {
        if((_application_logic_data__WEBPACK_IMPORTED_MODULE_1__.Data.getProject("Today") === undefined)){
            _application_logic_data__WEBPACK_IMPORTED_MODULE_1__.Data.addProject("Today");
        }
    }
})();
